...
|`powerbi.TabularEditorExecutable`|The path to the Tabular Editor executable. If not set, a dataset cannot be opened in Tabular Editor from this extension.|`%ProgramFiles(x86)%\\TabularEditor\\TabularEditor.exe`|
